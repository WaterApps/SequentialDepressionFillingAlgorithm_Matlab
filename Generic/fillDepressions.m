function[times, dem, flow_direction, pits, rainfall_excess, number_of_pits, depthFlow] = ...
    fillDepressions(dem, flow_direction, pits, pairs, cellIndexes, pitId, pitCell, areaCellCount, spilloverElevation, vca, volume, filledVolume, cellOverflowInto, R, visualize_merging)
