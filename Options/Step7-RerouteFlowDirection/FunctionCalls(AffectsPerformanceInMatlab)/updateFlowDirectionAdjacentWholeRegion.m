function[flow_direction] = updateFlowDirectionAdjacentWholeRegion(areaCellCount, pitId, cellOverflowInto, spilloverElevation, flow_direction, dem, pits, indexes)
