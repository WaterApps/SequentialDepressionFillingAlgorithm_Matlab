function[flow_direction, flow_direction_parents] = updateFlowDirectionAndParentsAdjacentWholeRegion(areaCellCount, pitId, cellOverflowInto, pitCell, spilloverElevation, flow_direction, flow_direction_parents, dem, pits, indexes)
