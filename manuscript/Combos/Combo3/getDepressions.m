function[pits, pitId, pitCell, areaCellCount, spilloverElevation, vca, volume, filledVolume, cellOverflowInto, pairs, cellIndexes] = getDepressions(dem, flow_direction, cellsize)
